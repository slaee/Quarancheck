				...
				if ($row['password']==sha1(md5($password))) {
					if ($row['position']=='Head') {
						...
						header('Location: dashboard.php');
							...
							if ($row['position']=='Guidance Counselor') {
						$_SESSION['user_login']=$username;
						header('Location: dashboard.php');
					}
...
<html lang="en">
  <head>
    ...
    <title>LOGIN | Guidance Counseling Services and Information & Orientation Services</title>
    <link rel="shortcut icon" href="unplogo.png">
  </head>
  <body>
