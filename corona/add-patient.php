					...
					<div class='content-body'>
						<div class='form-holder' style='margin-top: 50px;'>
							...
							if (isset($_POST['p-name'])) {
								...
								Patient::add($name, strtolower($street_address), strtolower($municipality), $dateOfBirth, $age, $gender, $phone, $traveled, $entered, $origin, $destination, $dname, $vtype, $plate, $antigen,  $diagnosis, $prescription, User::getToken(), $patientNumber, $condition);
							}
							?>
						</div>
