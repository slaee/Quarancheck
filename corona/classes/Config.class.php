...
class Config{
	...
	const DB_NAME = "covid-19"; // the actual name of the system's database [database name]
	...
	const SYSTEM_NAME = "corona virus";
	const SLOGAN = "covid-19"; // THIS CAN BE SYSTEM'S TITLE\ 
