...
<html>
<head>
	<title>Add Police Officers - <?php echo CONFIG::SYSTEM_NAME; ?></title>
		...
		<div class='row'>
			...
			<div class='col-md-7'>
				...
				<div class='content-header'> 
					<?php if(isset($_GET['token'])){ echo "Edit Doctor <small>Edit this Police Officer</small>"; } else { ?> Add Police Officers <small>Add Police Officers into the system</small> <?php } ?> 
				</div>
				...
				<div class='content-body'> 
					...
					<div class='form-holder'>
						<?php 
							...
							$form->textBox("Contact Number", "phone", "number", "$phone", "");
							...
							if(isset($_GET['token'] )){
								$form->close("Edit Police Officer"); 
							} else {
								$form->close("Add Police Officer"); 
							}
